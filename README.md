...
- Только **AmneziaWG** (разделы **1**, **3**): Весь **Интернет**-трафик (включая **YouTube**) уйдет в **VPN**-туннель.
...
### 3.3. Донастраиваем клиент AmneziaWG и маршрутизацию для него
...
### 3.4. Проверяем ключевые настройки
